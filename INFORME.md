...
Voy a dejar algunos comentarios sobre lo hehco en el tp. Casi todo el codigo y como construir la solucion se baso en el tutorial provisto por la catedra en el Readme sobre rabbit.
...
Por ultimo, se realzio el manejo de errores. Al principio, capturaba todo con Except. Para evitar esto y solo levantar los errores ante problemas con pika, ahora solo capturo errores del tipo AMQPError y AMQPConnectionError. 
